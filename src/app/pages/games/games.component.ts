...
import { GamesSkeletonComponent } from "../../shared/skeletons/games-skeleton/games-skeleton.component";
...
export class GamesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle(
      "Popular Games - Discover Top-Rated Titles and Must-Play Releases"
    );
  ...
  loadGames(page: number, filters: any = {}, orderBy?: string, name?: string) {
    ...
    this.gamesService
      ...
      .subscribe((data: any) => {
        ...
        this.onHover(
          this.games[0]?.urlName,
          this.games[0]?.gameName,
          this.games[0]?.headerImageUrl
        );
  ...
  updateMetaTags(games: any[]) {
    ...
    const baseKeywords =
      "popular games, top-rated video games, new game releases, best game deals, game discounts, cheap video games, trending video games, must-play games, video game offers, gaming discounts, PC games on sale, console games deals, Xbox game deals, PlayStation game deals, Steam game sales, playze.io";
    ...
    this.metaService.updateTag({
      name: "description",
      content:
        "Explore the most popular games across all platforms! Check out top-rated titles, trending releases, and fan-favorite games. Get deals and start playing now!",
    });
  }
